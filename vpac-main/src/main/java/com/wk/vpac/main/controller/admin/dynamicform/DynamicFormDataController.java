package com.wk.vpac.main.controller.admin.dynamicform;
...
import com.wk.vpac.main.service.admin.dynamicform.DynamicFormDataService;
...
public class DynamicFormDataController {
  ...
  @GetMapping("/dynamicform/codes")
  public ResponseEntity codes(@RequestParam Map<String, String> params) {
    return ResponseEntity.ok(dynamicFormDataService.listCode(params));
  }
  ...
  public ResponseEntity columns(@RequestParam Map<String, String> params) {
    ...
    if (StringUtils.isNotBlank(params.get("code"))) {
      result = dynamicFormDataService.columns(params);
    }
  ...
  public ResponseEntity type(@RequestParam Map<String, String> params) {
    List<String> arr = dynamicFormDataService.type(params);
  ...
  public ResponseEntity childColumns(@RequestParam Map<String, String> params) {
    ArrayNode arr = dynamicFormDataService.childColumns(params);
    return ResponseEntity.ok(arr);
  }
  ...
  public ResponseEntity child(@RequestParam Map<String, String> params) {
    List<Map> arr = dynamicFormDataService.child(params);
    return ResponseEntity.ok(arr);
  }
  ...
  public ResponseEntity codeSaveOrUpdate(@RequestParam Map<String, String> params) {
    return ResponseEntity.ok(dynamicFormDataService.saveOrUpdateCode(
      params.get("id"), ConvertUtil.checkNotNull(params, "code", String.class),
      ...
      params.get("remark"), ConvertUtil.convert(params.get("captcha"), false),
      ConvertUtil.convert(params.get("userAuth"), false),
      ConvertUtil.convert(params.get("notifyWxAdmin"), false),
      ConvertUtil.convert(params.get("notifyWxUser"), 1),
      ConvertUtil.convert(params.get("notifyWxUserLink"), ""),
      ConvertUtil.convert(params.get("status"), 1)
    ));
  }
  ...
  public ResponseEntity columnsSaveOrUpdate(@RequestParam Map<String, String> params) {
    ...
    return ResponseEntity.ok(dynamicFormDataService.saveOrUpdateColumns(
      params.get("id"), ConvertUtil.checkNotNull(params, "code", String.class),
  ...
  @RequireToken(UserMemberToken.class)
  @GetMapping("/dynamicform/data")
  public String queryFromData(ModelMap modelMap, @RequestParam Map<String, String> params) {
    String code = ConvertUtil.checkNotNull(params, "code", "缺少必要参数", String.class);
    modelMap.put("code", code);
    return "dynamicform/formData";
  }

  @RequireToken(UserMemberToken.class)
  @GetMapping("dynamicform/form/data")
  public ResponseEntity queryFromData(@RequestParam Map<String, String> params) {
    ConvertUtil.checkNotNull(params, "code", "缺少必要参数", String.class);
    DataPage page = dynamicFormDataService.queryFromData(params);
    return ResponseEntity.ok(page);
  }

  @SystemLogger
  @RequireToken(UserMemberToken.class)
  @PutMapping("/dynamicform/data/status")
  public ResponseEntity dataStatus(@RequestBody Map<String, String> params) {
    ...
    if (status != null) {
      dynamicFormDataService.updateStatus(id, status, params.get("result"));
    }
  ...
  @SystemLogger
  @RequireToken(UserMemberToken.class)
  @PutMapping("/dynamicform/data/remark")
  public ResponseEntity dataRemark(@RequestBody Map<String, String> params) {
    String id = ConvertUtil.checkNotNull(params, "id", String.class);
    String remark = params.get("remark");
    if (StringUtils.isNotBlank(remark)) {
      dynamicFormDataService.updateRemark(id, remark);
    }
    return ResponseEntity.ok(JsonResult.success());
  }
