...
import com.wk.vpac.main.service.admin.auth.SysRoleService;
import com.wk.vpac.main.service.admin.member.MemberNodeBuilder;
import com.wk.vpac.main.service.admin.member.SysMemberAttrService;
...
public class MemberController {
  ...
  public ResponseEntity tree(HttpServletRequest request, HttpServletResponse response) {
    List<TreeNodeData<SysMember>> treeNodeData =
      sysMemberService.loadTreeNodes(new TreeParam(request), SysMemberDao.ADMIN_TREE_KIND);
  ...
  public ResponseEntity saveOrUpdate(SysMember member) {
    ...
    return ResponseEntity.ok(JsonResult.success(new MemberNodeBuilder(sysMemberDao).buildNode(rs, null, null)));
  }
