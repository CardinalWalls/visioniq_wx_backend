...
import com.wk.vpac.main.service.admin.sys.VariableDataService;
...
public class VariableDataController {
  ...
  public ResponseEntity listData(@RequestParam(required = false) Map<String, String> params) {
    Page page = variableDataService.findAll(Pages.Helper.pageable(params, Sort.by(Sort.Direction.ASC, "type", "orderNo")));
