...
import com.wk.vpac.main.service.api.sys.SendMessageService;
...
public class SendMessageController {
   ...
   * @throws Exception
   */
  @PostMapping(path = GatewayPath.API + "/sys/sendSysTemplateMsg", produces = MediaType.APPLICATION_JSON_VALUE)
   ...
   * @throws Exception
   */
  @PostMapping(path = GatewayPath.API + "/sys/sendSmsTemplateMsg", produces = MediaType.APPLICATION_JSON_VALUE)
...
//   * @throws Exception
//   */
//  @PostMapping(path = GatewayPath.API + "/sys/sendWechatTemplateMsg", produces = MediaType.APPLICATION_JSON_VALUE)
