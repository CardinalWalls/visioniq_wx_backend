...
import com.wk.vpac.database.dao.admin.SysAppInfoRoleDao;
import com.wk.vpac.database.dao.admin.SysMemberRoleDao;
...
import com.wk.vpac.domain.admin.SysMemberRole;
...
public class SysRoleService extends AbstractJpaService<SysRole, String, SysRoleDao> {
  ...
  public SysRole saveAndFlush(SysRole sysRole){
    if(StringUtils.isNotBlank(sysRole.getId())){
      ...
      if (StringUtils.isNotEmpty(sysRole.getCode()) && !exists.getCode().equals(sysRole.getCode())) {
