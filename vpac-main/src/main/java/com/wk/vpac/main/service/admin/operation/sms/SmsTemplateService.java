...
import com.wk.vpac.database.dao.sys.SmsTemplateDao;
import com.wk.vpac.database.dao.sys.SmsTemplateParamDao;
...
public class SmsTemplateService extends AbstractJpaService<SmsTemplate, String, SmsTemplateDao> {
  ...
  public SmsTemplate saveOrUpdate(Map<String, String> params) throws IOException {
    ...
    ArrayNode array = JsonUtils.reader(paramArrayStr, ArrayNode.class);
    ...
    if (array != null && array.size() != 0) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        smsTemplateParam.setParamCode(o.path("paramCode").asText());
        smsTemplateParam.setParamName(o.path("paramName").asText());
        smsTemplateParam.setType(o.path("type").asInt());
        smsTemplateParam.setSysParamType(o.path("sysParamType").asText());
