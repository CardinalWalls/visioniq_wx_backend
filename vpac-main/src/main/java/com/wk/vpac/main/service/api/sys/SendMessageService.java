...
import com.wk.vpac.common.service.service.template.SysMessageManagerTemplates;
...
@Service
//@RefreshScope
@EnableConfigurationProperties(SysMessageManagerTemplates.class)
public class SendMessageService {
  ...
  @Autowired
  private SysMessageManagerTemplates sysMsgTemplates;
