...
!function (t) {
  ...
  function v(e, n) {
    if (e && n) {
      if (e instanceof HTMLElement && e.classList && !t.isIE9()) {
        if (n.indexOf(" ") < 0) e.classList.add(n); else for (var r = n.split(" "), i = 0; i < r.length; i++) e.classList.add(r[i]);
        return
      }
      if (e.setAttribute) for (var r = n.split(" "), i = 0; i < r.length; i++) {
        var o = r[i];
        if (!_(e, o)) {
  ...
  function y(e, n) {
    if (e && n) {
      if (e instanceof HTMLElement && e.classList && !t.isIE9()) {
        if (n.indexOf(" ") < 0) e.classList.remove(n); else for (var r = n.split(" "), i = 0; i < r.length; i++) e.classList.remove(r[i]);
        return
      }
      if (e.setAttribute) for (var r = n.split(" "), i = 0; i < r.length; i++) {
        var o = r[i];
        if (_(e, o)) {
          var s = new RegExp("((\\s|^)" + o + "(\\s|$))", "g"), a = e.getAttribute("class");
  ...
  function E(e) {
    for (var n = [], r = e.querySelectorAll("input,select,textarea,button,a,div"), i = 0; i < r.length; i++) {
      var o = r[i];
      if (o.offsetHeight > 0 && o.tabIndex > -1 && !o.disabled && !O(o, "[disabled],.wj-state-disabled")) {
        ...
        if (t.isIE() && !o.hasAttribute("tabindex")) {
          ...
          var s = t.Control.getControl(O(o, ".wj-flexgrid"));
  ...
  function x(e, n, r) {
    for (var i = n; i && e;) {
      if (i === e) return !0;
      i = (r ? i[t.Control._OWNR_KEY] : null) || i.parentNode || i.host
    }
    return !1
  }
  ...
  function O(t, e) {
    ...
    if (n) for (; t; t = t.parentNode) if (t instanceof Element && n.call(t, e)) return t;
    return null
  }

  function S(t, e) {
    if (p(c(e), "css parameter should be an object"), t instanceof Array) for (var n = 0; n < t.length; n++) S(t[n], e); else if (t && t.style) {
      var r = t.style;
      for (var i in e) {
        var o = e[i];
  ...
  var I = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;"};
  t.toPlainText = function (t) {
    var e = t;
    return e.indexOf("<") > -1 && (this._cvt || (this._cvt = document.createElement("div")), this._cvt.innerHTML = e, e = this._cvt.textContent), e
  };
  t.hasClass = _, t.addClass = v, t.removeClass = y, t.toggleClass = b, t.setAttribute = C, t.setAriaLabel = function (t, e) {
    ...
    t.textContent = e || ""
  }, t.contains = x, t.closest = O, t.closestClass = function (t, e) {
    return O(t, "." + e)
  ...
  var D = function () {
    ...
    return Object.defineProperty(t.prototype, "right", {
      ...
      var r = Math.min(e.left, n.left), i = Math.min(e.top, n.top);
      return new t(r, i, Math.max(e.right, n.right) - r, Math.max(e.bottom, n.bottom) - i)
    }, t.intersection = function (e, n) {
      var r = Math.max(e.left, n.left), i = Math.max(e.top, n.top);
  ...
  var j = function () {
    ...
    return e.addDays = function (t, n) {
      ...
      var u = new Date(t, e, n, r, i, o, s), c = u.getFullYear();
  ...
  t.DateTime = j, t.httpRequest = function (t, e) {
    e || (e = {});
    var i = e.method ? f(e.method).toUpperCase() : "GET", o = null == e.async || g(e.async), u = e.data;
    if (null != u && "GET" == i) {
      var l = [];
      for (var h in u) {
        var p = u[h];
    ...
    if (null == u || n(u) || (_ = c(u), u = JSON.stringify(u)), d.onload = function () {
      ...
      e.error(d)
    }, d.open(i, t, o, e.user, e.password), e.user && e.password && d.setRequestHeader("Authorization", "Basic " + btoa(e.user + ":" + e.password)), _ && d.setRequestHeader("Content-Type", "application/json"), e.requestHeaders) for (var v in e.requestHeaders) d.setRequestHeader(v, e.requestHeaders[v]);
...
!function (t) {
  ...
  var e = function () {
    ...
    return e.format = function (n, r, i, o) {
      ...
      var s, a = t.culture.Globalize.numberFormat, u = r ? r.match(/([a-z])(\d*)(,*)(.*)/i) : null,
        c = u ? u[1].toLowerCase() : "n",
        l = u && u[2] ? parseInt(u[2]) : "c" == c ? a.currency.decimals : n == Math.round(n) ? 0 : 2,
        h = u && u[3] ? 3 * u[3].length : 0, p = a["."] || ".", f = a[","] || ",", d = a["-"] || "-";
      ...
      if ("p" == c && (n = e._shiftDecimal(n, 2), n = t.toFixed(n, l, o)), o && "p" != c && (n = t.toFixed(n, l, !0)), s = "c" == c || "p" == c ? e._toFixedStr(Math.abs(n), l) : e._toFixedStr(n, l), (i || "g" == c) && s.indexOf(".") > -1 && (s = (s = s.replace(/(\.[0-9]*?)0+$/g, "$1")).replace(/\.$/, "")), "." != p && (s = s.replace(".", p)), "-" != d && (s = s.replace("-", d)), f && ("n" == c || "c" == c || "p" == c)) {
        var g = s.indexOf(p), m = /\B(?=(\d\d\d)+(?!\d))/g;
        s = g > -1 ? s.substr(0, g).replace(m, f) + s.substr(g) : s.replace(m, f)
      }
      if ("c" == c) {
        var _ = a.currency.pattern[n < 0 ? 0 : 1], v = u && u[4] ? u[4] : a.currency.symbol;
        "​" == v && (v = ""), s = _.replace("n", s).replace("$", v)
      }
      if ("p" == c) {
        var _ = a.percent.pattern[n < 0 ? 0 : 1], y = a["%"] || "%";
    ...
    }, e.parseFloat = function (n, r) {
      var i = t.culture.Globalize.numberFormat, o = i["-"] || "-", s = i["%"] || "%",
        a = n.indexOf(o) > -1 || n.indexOf("(") > -1 && n.indexOf(")") > -1 ? -1 : 1, u = n.indexOf(s) > -1,
        c = r ? r.match(/,+/) : null, l = c ? 3 * c[0].length : 0, h = 0;
      if (!r || "x" != r[0] && "X" != r[0]) {
        var p = i["."] || ".", f = new RegExp("[^\\d\\" + p + "]", "g");
        n = n.replace(f, "").replace(p, "."), h = parseFloat(n)
      } else n = n.replace(/[^0-9a-f]+.*$/gi, ""), h = parseInt(n, 16);
      return u && (h = e._shiftDecimal(h, -2)), h * a * Math.pow(10, l)
    }, e.parseDate = function (n, r, i) {
      if (!(n = t.asString(n))) return null;
      if ("u" == r) return new Date(n);
      var o;
      if ("R" == r || "r" == r) {
        var s = /(([0-9]+)\-([0-9]+)\-([0-9]+))?\s?(([0-9]+):([0-9]+)(:([0-9]+))?)?/, a = n.match(s);
      ...
      var u, c, l, h, p, f, d = t.culture.Globalize.calendar, g = e._CJK,
        m = new RegExp("(\\" + d["/"] + ")|(\\" + d[":"] + ")|(\\d+)|([" + g + "\\.]{2,})|([" + g + "]+)", "gi"),
        _ = n.match(m), v = e._parseDateFormat(r), y = 0, b = -1, C = 0, w = 1, E = 0, A = 0, x = 0, O = 0, S = -1;
      if (!(_ && _.length && v && v.length)) return null;
      for (var T = 0; T < v.length && _; T++) {
        var P = T - y, I = P > -1 && P < _.length ? _[P] : "", F = v[T].length;
        switch (v[T]) {
          case"EEEE":
          case"EEE":
          case"EE":
          ...
          case"yy":
          case"y":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), b = parseInt(I), p = 4 == I.length;
            break;
          case"MMMM":
          case"MMM":
            h = !0;
            var M = I.toLowerCase();
            C = -1;
            for (var D = 0; D < 12; D++) if (0 == d.months[D].toLowerCase().indexOf(M)) {
              C = D;
              break
            }
            if (C > -1) break;
          case"MM":
          case"M":
            h = !0, F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), C = parseInt(I) - 1;
            break;
          case"dddd":
          case"ddd":
            u = !0;
          ...
          case"dd":
          case"d":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), w = parseInt(I), c = !0;
            break;
          case"hh":
          case"h":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), E = 12 == (E = parseInt(I)) ? 0 : E;
            break;
          case"HH":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), E = parseInt(I);
            break;
          case"H":
            E = parseInt(I);
            break;
          case"mm":
          case"m":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), A = parseInt(I);
            break;
          case"ss":
          case"s":
            F > 1 && I.length > F && (_[P] = I.substr(F), I = I.substr(0, F), y++), x = parseInt(I);
            break;
          case"fffffff":
          case"FFFFFFF":
          case"ffffff":
          ...
          case"gg":
          case"g":
            S = d.eras.length > 1 ? e._getEra(I, d) : -1;
            break;
          case"/":
          case":":
            if (I && I != d[v[T]]) return null;
            break;
          case"K":
            break;
          default:
      ...
      if (f) {
        ...
        if (t.isArray(j.fiscalYearOffsets)) {
          var N = "E" == f[0], L = C - j.fiscalYearOffsets[N ? 0 : 1];
          b += L > 11 ? -1 : L < 0 ? 1 : 0
        }
      }
      if (u && !c) return null;
      if (l && !h) return null;
      if (b < 0) b = t.isDate(i) ? i.getFullYear() : (new Date).getFullYear(); else if (S > -1) b = b + d.eras[S].start.getFullYear() - 1; else if (b < 100 && !p) {
        var R = t.isNumber(d.twoDigitYearMax) ? d.twoDigitYearMax : 2029;
        R > 99 && (b += b + 2e3 <= R ? 2e3 : 1900)
      }
      return w > new Date(b, C + 1, 0).getDate() ? null : (o = t.DateTime.newDate(b, C, w, E, A + 0, x, O), isNaN(o.getTime()) ? null : o)
      ...
      var n = t.toString(), r = n.indexOf("."), i = e - (n.length - r) + 1;
      ...
      var n, r, i = [];
      if (t) for (n = 0; n > -1 && n < t.length; n++) {
        var o = t[n];
        if (("'" == o || '"' == o) && (r = t.indexOf(o, n + 1)) > -1) i.push(t.substring(n, r + 1)), n = r; else if ("\\" == o && n < t.length - 1) n++, i.push('"' + t[n] + '"'); else {
      ...
      var o, s = t.culture.Globalize.calendar, a = 0, u = 0, c = 0, l = i.length;
      switch (i) {
        case"yyyy":
        case"yyy":
        case"yy":
        ...
        case"zz":
        case"z":
          var d = -n.getTimezoneOffset(), g = void 0;
          switch (i) {
            case"zzz":
      ...
      if (t.isDate(e)) {
        for (r = 0; r < n.eras.length; r++) if (e >= n.eras[r].start) return r
      } else if (t.isString(e)) for (var r = 0; r < n.eras.length; r++) if (n.eras[r].name && (0 == n.eras[r].name.indexOf(e) || 0 == n.eras[r].symbol.indexOf(e))) return r;
      return -1
    }, e._expandFormat = function (e) {
      var n = t.culture.Globalize.calendar.patterns[e];
      return n || e
    }, e._zeroPad = function (t, e) {
      var n = t.toFixed(0), r = e - n.length + 1;
      return r > 0 ? Array(r).join("0") + n : n
    }, e._h12 = function (e) {
      var n = t.culture.Globalize.calendar, r = e.getHours();
      return n.am && n.am[0] && 0 == (r %= 12) && (r = 12), r
    }, e._shiftDecimal = function (t, e) {
      if (0 == e) return t;
      var n = t.toString();
      if (n.indexOf("e") > -1) return t * Math.pow(10, e);
      var r = Array(Math.abs(e) + 1).join("0");
      e < 0 && (n = r + n);
      var i = n.indexOf(".");
      return i < 0 && (i = (n += ".").indexOf(".")), e > 0 && (n += r), i += e, n = n.replace(".", ""), n = n.substr(0, i) + "." + n.substr(i), parseFloat(n)
    ...
    return Object.defineProperty(t.prototype, "path", {
      get: function () {
        ...
        for (var e = 0; e < this._parts.length; e++) {
          var n = this._parts[e], r = n.indexOf("[");
      ...
      if (t) {
        ...
        for (var n = 0; n < this._parts.length - 1; n++) if (null == (t = t[this._parts[n]])) return;
...
!function (t) {
  ...
  var r = e || t.controlBaseClass !== Object, i = function (t) {
    function e() {
      var e = this;
  ...
  var o = function (e) {
    function n(r, i, o) {
      ...
      if (u(a, "mousedown", h, !0), u(a, "mouseup", h, !0), u(a, "click", h, !0), u(a, "dblclick", h, !0), u(a, "wheel", h, t.getEventOptions(!0, !0)), u(a, "keydown", function (e) {
        ...
        var p = document.body, f = p.addEventListener.bind(p), d = s._handleTouchStart, g = s._handleTouchEnd,
    ...
    return __extends(n, e), n.prototype.getTemplate = function () {
      ...
      var f = a.querySelectorAll("input"), d = 1 == f.length ? f[0] : null;
      if (d) {
      ...
      if (d) {
        var y = document.createEvent("HTMLEvents"), b = d.value;
      ...
      if (d ? a.tabIndex = -1 : a.getAttribute("tabindex") || (a.tabIndex = 0), this._updateState(), i) for (var C in i) {
        var w = i[C];
      ...
      if (this._e) {
        ...
        if (s instanceof t.collections.CollectionView) for (var o in s) {
          var a = s[o];
      ...
      var e = this._e, r = t.getActiveElement();
      if (!e) return !1;
      for (var i = r; i;) {
        if (i == e) return !0;
      ...
      if (t || (t = document.body), t.children) for (var e = 0; e < t.children.length; e++) n.invalidateAll(t.children[e]);
      var r = n.getControl(t);
      r && r.invalidate()
    }, n.refreshAll = function (t) {
      if (t || (t = document.body), t.children) for (var e = 0; e < t.children.length; e++) n.refreshAll(t.children[e]);
      var r = n.getControl(t);
      r && r.refresh()
    }, n.disposeAll = function (t) {
      var e = n.getControl(t);
      if (e) e.dispose(); else if (t.children) for (var r = 0; r < t.children.length; r++) n.disposeAll(t.children[r])
      ...
      if (e) {
        ...
        e.addEventListener(n, r, s), this._listeners.push({target: e, type: n, fn: r, capture: i})
      }
    }, n.prototype.removeEventListener = function (t, e, n, r) {
      for (var i = 0, o = 0; o < this._listeners.length; o++) {
        var s = this._listeners[o];
        null != t && t != s.target || null != e && e != s.type || null != n && n != s.fn || null != r && r != s.capture || (s.target.removeEventListener(s.type, s.fn, s.capture), this._listeners.splice(o, 1), o--, i++)
      }
      return i
...
!function (t) {
  ...
  !function (t) {
    ...
    var o = 0, s = 0, a = 0, u = 0, c = null, l = null, h = null, p = i ? new t.Binding(i) : null;
  ...
  !function (e) {
    ...
    var n = function () {
      ...
      return n.prototype._copy = function (n, r) {
        ...
        var t = this._srtDsc, e = this._srtCvt, r = this._srtCmp, i = this._nullsFirst ? -1 : 1, o = !0, s = 0;
        return function (a, u) {
          for (var c = 0; c < t.length; c++) {
            var l = t[c], h = l._bnd.getValue(a), p = l._bnd.getValue(u);
            ...
            if ("string" == typeof h && "string" == typeof p) {
              ...
              var d = h.toLowerCase(), g = p.toLowerCase();
              d != g && (h = d, p = g)
            }
        ...
        var t = this._edtItem, n = this._edtClone;
        if (null != t) {
          this._committing = !0;
          var r = this._sameContent(t, n), i = this._pendingRefresh;
          this._edtItem = null, this._edtClone = null;
          var o = this._pgView.indexOf(t), s = this._digest;
        ...
        var n = null, r = this.sourceCollection;
        ...
        if (null != t) {
          this._newItem = null;
          var n = this._pgView.indexOf(t), r = this._digest;
        ...
        if (r && (this._newItem = null), n == this._edtItem && this.cancelEdit(), this.canRemove) {
          ...
          if (i > -1) {
            ...
            var c = this.sortDescriptions.length > 0, l = this.pageSize > 0 && this._pgIdx > -1;
        ...
        if (this._trackChanges) {
          ...
          if (n && n.indexOf(t) > -1) {
            var r = this._chgEdited.indexOf(t), i = e.NotifyCollectionChangedAction.Change;
            if (r < 0 && this._chgAdded.indexOf(t) < 0) this._chgEdited.push(t); else if (r > -1) {
        ...
        for (var r in n) if (!this._sameValue(e[r], n[r])) return !1;
        for (var r in e) if (!this._sameValue(e[r], n[r])) return !1;
        return !0
        ...
        var t = this._pgSz * this._pgIdx, e = Math.min(t + this._pgSz, this._view.length);
        return this._view.slice(t, e)
      }, n.prototype._createGroups = function (e) {
        if (!this._grpDesc || !this._grpDesc.length) return null;
        for (var n = [], r = {}, i = null, o = 0; o < e.length; o++) for (var s = e[o], a = n, u = this._grpDesc.length, c = "", l = 0; l < u; l++) {
          var h = this._grpDesc[l], p = h.groupNameFromItem(s, l), f = l == u - 1;
        ...
        for (var e = [], n = 0; n < t.length; n++) {
          var r = t[n];
          if (!r._isBottomLevel) for (var i = this._mergeGroupItems(r.groups), o = 0, s = i.length; o < s; o++) r._items.push(i[o]);
        ...
        if (i && t.isPrimitive(o)) {
          if (u = i[o]) return u
        } else for (var c = 0; c < n.length; c++) if (e.namesMatch(n[c].name, o)) return n[c];
        var l = new r(e, o, s, a);
        return n.push(l), i && (i[o] = l), l
      }, n._collator = "undefined" != typeof window && window.Intl && Intl.Collator ? new Intl.Collator : null, n
    }();
    e.CollectionView = n;
    var r = function () {
      function e(t, e, n, r) {
      ...
      return Object.defineProperty(e.prototype, "name", {
        ...
        var o = t.tryCast(i, n), s = o ? o._getFullGroup(this) : this;
...
!function (t) {
  ...
  var e = function () {
    ...
    return e.prototype.setTooltip = function (e, n) {
      ...
      e = t.getElement(e);
      for (var n = this._tips, r = 0; r < n.length; r++) if (n[r].element == e) return n[r].content;
      return null
    }, e.prototype.show = function (r, i, o) {
      r = t.getElement(r), i = this._getContent(i), o || (o = t.Rect.fromBoundingRect(r.getBoundingClientRect()));
      var s = e._eTip;
      s || (s = e._eTip = document.createElement("div"), t.addClass(s, "wj-tooltip"), s.style.visibility = "none"), t.addClass(s, this.cssClass), this._setContent(i);
      var a = new n(i, r);
      ...
      var n = e._eTip;
      n && (t.removeChild(n), t.removeClass(n, this.cssClass), n.innerHTML = ""), document.removeEventListener("mousedown", this._hideAutoTipBnd)
      ...
      for (var e = 0; e < this._tips.length; e++) if (this._tips[e].element == t) return e;
      return -1
      ...
      var n = this;
      if (!e.defaultPrevented) if ("click" != e.type || t.Control._touching) {
        var r = "mouseenter" == e.type ? this._showDelay : 0, i = this._hideDelay;
        this._clearTimeouts(), this._toShow = setTimeout(function () {
          var r = n._indexOf(e.target);
          if (r > -1) {
            var o = n._tips[r], s = n._showAtMouse ? new t.Rect(e.clientX, e.clientY, 0, 0) : null;
      ...
      var n = e._eTip;
      n && (this._html ? n.innerHTML = t : n.textContent = t)
    }, e
  }();
  t.Tooltip = e;
  var n = function (n) {
    function r(e, r) {
      ...
      return i._content = t.asString(e), i._e = r, i
    }

    return __extends(r, n), Object.defineProperty(r.prototype, "tip", {
      get: function () {
        return e._eTip
      }, enumerable: !0, configurable: !0
...
!function (t) {
  ...
  var e = function () {
    ...
    return Object.defineProperty(e.prototype, "r", {
      ...
      var o = e._rgbToHsl(n.r, n.g, n.b), s = e._rgbToHsl(r.r, r.g, r.b), a = 1 - i, u = n.a * a + r.a * i,
        c = [o[0] * a + s[0] * i, o[1] * a + s[1] * i, o[2] * a + s[2] * i], l = e._hslToRgb(c[0], c[1], c[2]);
      ...
      if (0 == n.indexOf("hsl")) {
        ...
        if (o > -1 && s > -1) {
          ...
          if (a.length > 2) {
            var u = parseInt(a[0]) / 360, c = parseInt(a[1]), l = parseInt(a[2]);
      ...
      var o, s, a;
      if (0 == r) o = s = a = i; else {
        var u = i < .5 ? i * (1 + r) : i + r - i * r, c = 2 * i - u;
      ...
      var i, o, s = Math.max(e, n, r), a = Math.min(e, n, r), u = (s + a) / 2;
      if (s == a) i = o = 0; else {
        var c = s - a;
      ...
      var i = t.clamp(r * (2 - n) / 2, 0, 1), o = 1 - Math.abs(2 * i - 1), s = t.clamp(o > 0 ? r * n / o : n, 0, 1);
  ...
  var e = function () {
    ...
    return e.copy = function (n) {
      ...
      if (i = i || document.body) {
        var o = t.createElement('<textarea class="wj-clipboard" style="position:fixed;opacity:0"/>', i), s = !1;
...
!function (t) {
  ...
  function n(e) {
    var n = window.jQuery, r = t.isFunction(n) ? n(e) : null;
  ...
  t.showPopup = function (r, i, o, s, a) {
    ...
    if (i instanceof HTMLElement) {
      ...
      for (var c = i; c; c = c.parentElement) if ("DIALOG" == c.tagName || n(c) || "fixed" == getComputedStyle(c).position) {
        u = c;
        break
      }
    }
    ...
    var l = document.body, h = new t.Point(l.scrollLeft || pageXOffset, l.scrollTop || pageYOffset),
      p = document.documentElement, f = p.clientWidth / window.innerWidth;
    if (u != l || f > 1.005) {
    ...
    if (h.x -= parseFloat(m.borderLeftWidth), h.y -= parseFloat(m.borderTopWidth), i instanceof HTMLElement && a) {
      var _ = a instanceof HTMLElement ? a : i, v = getComputedStyle(_);
    ...
    var y = getComputedStyle(r), b = parseFloat(y.marginTop) + parseFloat(y.marginBottom),
      C = parseFloat(y.marginLeft) + parseFloat(y.marginRight), w = new t.Size(r.offsetWidth + C, r.offsetHeight + b),
      E = t.hasClass(r, "wj-rtl") || "rtl" == r.getAttribute("dir"), A = new t.Point, x = null, O = p.clientWidth,
      S = p.clientHeight;
    if (i && null != i.clientX && null != i.clientY && null != i.pageX && null != i.pageY) i.clientX <= 0 && i.clientY <= 0 && i.target ? x = i.target.getBoundingClientRect() : (A.x = i.pageX - pageXOffset, A.y = i.pageY - pageYOffset, E && (A.x -= w.width)); else if (i instanceof t.Point) A = i, E && (A.x -= w.width); else if (i instanceof HTMLElement) x = i.getBoundingClientRect(); else if (i && null != i.top && null != i.left) x = i; else {
      if (null != i) throw"Invalid ref parameter.";
      A.x = (O - w.width) / 2, A.y = Math.round((S - w.height) / 2 * .7)
    }
    ...
    if (x) {
      ...
      var P = x.top, I = S - x.bottom;
      A.y = o ? P > w.height || P > I ? x.top - w.height : x.bottom : I > w.height || I > P ? x.bottom : x.top - w.height
    }
    A.y + w.height > S - 20 && (A.y = Math.max(0, S - 20 - w.height)), A.x + w.width > O - 20 && (A.x = Math.max(0, O - 20 - w.width)), A.x = Math.max(0, A.x) + h.x, A.y = Math.max(0, A.y) + h.y;
    var F = {position: "absolute", opacity: s ? "0" : "", minWidth: T, zIndex: t.Control._POPUP_ZINDEX};
    ...
    if (D instanceof HTMLElement && D.parentElement != document.body) {
      var j = Date.now(), N = D.getBoundingClientRect(), L = new t.Control(document.createElement("div"));
      r[t.Control._SCRL_KEY] = L, L.addEventListener(document, "scroll", function (n) {
        if (n.target != r.parentElement && Date.now() - j > 100 && t.contains(document, D) && !t.contains(r, n.target) && (n.target != document || null != i && "fixed" == r.style.position)) {
          var o = D.getBoundingClientRect(), s = Math.abs(o.left - N.left), a = Math.abs(o.top - N.top);
...
!function (t) {
  ...
  var e = function () {
    ...
    return Object.defineProperty(e.prototype, "title", {
      ...
      var n = this._getDocument(), r = n.body, i = !1;
      if (r) if (t.isString(e)) r.appendChild(t.createElement(e)); else if (e instanceof Node) {
        o = this._cloneNode(e);
        r.appendChild(o)
      } else i = !0; else if (t.isString(e)) n.write(e); else if (e instanceof HTMLElement) {
      ...
      this._iframe && (this._close(), setTimeout(function () {
        var n = e._iframe.contentWindow, r = "onafterprint" in n && !t.isFirefox();
      ...
      if (e.close(), e.title = null != this.title ? this.title : document.title, e.title && e.title.trim() || (e.title = " "), this._copyCss) {
        for (var n = document.head.querySelectorAll("link"), r = 0; r < n.length; r++) {
          ...
          if (i.href.match(/\.css$/i) && i.rel.match(/stylesheet/i)) {
            a = t.httpRequest(i.href, {async: !1});
      ...
      if (this._css) for (r = 0; r < this._css.length; r++) {
        var s = e.createElement("style"), a = t.httpRequest(this._css[r], {async: !1});
        s.textContent = a.responseText, e.head.appendChild(s)
      }
    }, e.prototype._addStyle = function (t) {
      var e = this._getDocument(), n = e.createElement("style");
...
!function (t) {
  ...
  function r(e, n, r) {
    /*var u = t.culture.Licensing || F, l = null;
    r ? o(e, r) ? s(e, r) ? a(e, r) ? i(e, r) ? c(e, r) && (l = u.evl) : l = u.prd : l = u.dmn : l = u.ver : l = u.exp : l = n ? u.lic : u.mss, l && h(e, l += "<br/><br/>" + u.ctc, r)*/
  }

  function i(t, n) {
    var r = e(t);
    if (r && r.length >= 4) for (var i = 0; i < n.Prd.length; i++) if (n.Prd[i].C.indexOf(r) > -1) return !0;
    return !1
  }
  ...
  function s(e, n) {
    var r = n.Anl ? n.Anl.ver : null, i = t.getVersion();
    return !r || !i || parseInt(r.replace("v", "")) + 10 >= parseInt(i.split(".")[1])
  }

  function a(t, e) {
    if (l() || !e.Dms) return !0;
    for (var n = location.hostname, r = e.Dms.split(","), i = 0; i < r.length; i++) if (u(n, r[i])) return !0;
    return !1
  }

  function u(t, e) {
    var n = "^" + e.replace(/\./g, "\\.").replace(/\*/g, "(.*)") + "$", r = new RegExp(n, "i").test(t);
    return r || "*." != e.substr(0, 2) ? r : u(t, e.substr(2))
  }
  ...
  function l() {
    var t = atob("Xih8bG9jYWxob3N0fGZpZGRsZS5qc2hlbGwubmV0fHJ1bi5wbG5rci5jb3xzLmNvZGVwZW4uaW98bnVsbC5qc2Jpbi5jb218Liouc3RhY2tibGl0ei5pb3wxMjcuMC4wLjEpJA=="),
      e = new RegExp(t, "i");
    return location.hostname.match(e)
  }

  function h(e, n, r) {
    if (n = f(e, n, r), !M[" "] && !l() && !c(e, r)) {
      M[" "] = !0;
      var i = t.culture.Licensing || F,
    ...
    if (!t.Control._wme) {
      var o = '<div><a href="' + p() + '" target="_blank" rel="noopener">' + f(e) + "</a></div>",
        a = t.createElement(o), u = {
          position: "fixed",
          display: "block",
          visibility: "visible",
      ...
      t.setCss(a, u), document.body.appendChild(a), t.Control._wme = a, (new t.Tooltip).setTooltip(a, n)
    }
  }
  ...
  function f(e, r, i) {
    (!r || r.trim().length < 15) && (r = (t.culture.Licensing || F).evl), (!r || r.trim().length < 15) && (r = atob("V2lqbW8gRXZhbHVhdGlvbiBWZXJzaW9uICh7dmVyc2lvbn0p"));
    var o = null;
    if (i && i.Exp) {
      var s = i.Exp;
  ...
  function d(t, e, n, r) {
    var i = g(t, e.algorithmCode);
    if (!i) return r();
    var o = i.lic, s = i.prefix + "#" + e.algorithmCode;
    if (T(s + JSON.stringify(o.D)) != o.H) return r();
    var a = window.msCrypto || window.crypto, u = a ? a.subtle : null;
    if (!u || !location.protocol.match(/^https/i)) return n(o.D);
    var c = {name: "RSASSA-PKCS1-v1_5", hash: {name: "SHA-256"}},
      l = {alg: "RS256", e: "AQAB", kty: "RSA", n: O(e.publicKey)};
    l = window.msCrypto ? S(JSON.stringify(l)) : l;
    try {
      P(u.importKey("jwk", l, c, !1, ["verify"])).then(function (t) {
        var e = s + E(A(x(JSON.stringify(o.D))));
        P(u.verify(c, t, A(o.S), S(e))).then(function (t) {
          return t ? n(o.D) : r()
        })
      }, function () {
        return n(o.D)
  ...
  function g(t, e) {
    try {
      e = "#" + e;
      var n = t.indexOf(e);
      if (n > -1) return {prefix: t.substring(0, n), lic: JSON.parse(m(t.substr(n + e.length)))}
    } catch (t) {
    }
    return null
  }
  ...
  function m(t) {
    ...
    return e = e.substr(n) + e.substr(0, n), e = e.replace("#", "="), e = e.replace("&", "=="), w(e)
  }

  function _(t) {
    for (var e = t.split(""), n = e.length - 5; n >= 0; n--) v(e, n + 1, n + 3, b), v(e, n, n + 2, b);
    return e.join("")
  }
  ...
  function E(t) {
    return String.fromCharCode.apply(null, new D(t))
  }

  function A(t) {
    for (var e = atob(t), n = e.length, r = new D(n), i = 0; i < n; i++) r[i] = e.charCodeAt(i);
    return r.buffer
  }
  ...
  function S(t) {
    for (var e = new ArrayBuffer(t.length), n = new D(e), r = 0, i = t.length; r < i; r++) n[r] = t.charCodeAt(r);
    return e
  }
  ...
  var I = "The Wijmo license in this application ", F = {
    evl: "",
  ...
  t._updateWme = function (n, i) {
    ...
    if (!(o && t.contains(document.body, o) && o.offsetWidth && o.offsetHeight)) if (i) {
      var s = e(n);
      M[s] || (M[s] = !0, d(i, {
        algorithmCode: "B0",
  ...
  var D = "undefined" == typeof window ? null : window.Uint8Array || window.TypedArray
}(wijmo || (wijmo = {}));
var wijmo;
!function (t) {
  "use strict";
  var e = function () {
    ...
    return Object.defineProperty(e.prototype, "input", {
      ...
      if (e.keyCode == t.Key.Back) {
        var n = this._tbx.selectionStart, r = this._tbx.selectionEnd;
      ...
      if (e && this._mskArr.length) {
        var n = this._tbx, r = n.selectionStart, i = String.fromCharCode(e);
        if (r < this._firstPos && (r = this._firstPos, t.setSelectionRange(n, r)), r >= this._mskArr.length) return !0;
        var o = this._mskArr[r];
        if (o.literal) this._validatePosition(r); else if (o.wildCard != i && !this._isCharValid(o.wildCard, i)) return !0
      }
      return !1
      ...
      var t = this._tbx, e = t.value.length < 2, n = t.selectionStart, r = n > 0 ? t.value[n - 1] : "", i = t.value;
      ...
      var e = "", n = 0, r = this._promptChar;
      t = this._handleVagueLiterals(t);
      for (var i = 0; i < this._mskArr.length; i++) {
        var o = this._mskArr[i], s = o.literal;
        if (s && s == t[n] && n++, o.wildCard) {
          if (s = r, t) {
            for (var a = n; a < t.length; a++) if (this._isCharValid(o.wildCard, t[a])) {
      ...
      if (0 != n && e.length > 1) {
        for (var r = -1, i = this._tbx, o = i == t.getActiveElement() ? i.selectionStart : i.value.length, s = Math.max(0, o - n); s < this._mskArr.length; s++) if (this._mskArr[s].vague) {
          r = s;
          break
        }
        if (r > -1) if (n < 0) {
          var a = Array(1 - n).join(this._promptChar), u = r + n;
      ...
      var n = this._mskArr;
      if (this._backSpace) for (; e > 0 && e < n.length && n[e - 1].literal;) e--;
      if (0 == e || !this._backSpace) for (; e < n.length && n[e].literal;) e++;
      ...
      for (o = 0; o < this._mskArr.length; o++) {
        ...
        if (s.literal) for (var a = 0; a < o; a++) {
...
!function (t) {
  ...
  "undefined" != typeof document && document.addEventListener("test", function (t) {
    ...
    return c ? {capture: t, passive: e} : t
  };
  var l = !1;
  if ("undefined" != typeof document && document.createElement("div").focus({
    ...
    if (1 == e.which) {
      ...
      if (n && !n.style.cursor) for (var r = e.target; r; r = r.parentElement) if (r.attributes && r.attributes.draggable) return r.dragDrop(), !1
    }
    ...
    if (!window[h]) {
      var p = 0;
      window[h] = function (t) {
        var e = Date.now(), n = 16 - (e - p), r = n > 0 ? n : 0;
    ...
    if (!window.atob) {
      var f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = new RegExp("[^" + f + "]");
      window.atob = function (t) {
        var e, n, r, i, o = [], s = 0, a = t.length;
