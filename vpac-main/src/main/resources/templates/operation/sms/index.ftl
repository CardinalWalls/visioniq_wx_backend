            ...
            <div class="tabs-container">
              <ul class="nav nav-tabs" id="mode_tab">
                ...
                <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false"
                                onclick="setSendMode(1)">手动发送模式</a>
                </li>
              </ul>
              <div class="tab-content">
                <div id="tab-1" class="tab-pane active">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="inline"><b class="label label-primary f-s"></b> - 接收人员：</h4><span
                      style="font-style: italic">默认发送列表的前1000名人员</span>
                      <div class="row">

                        <div class="panel-body table-content">
                          <form class="table-search" name="contact_search_form">
                            <div class="form-inline">
                              ...
                              <div class="form-group">
                                ...
                                <select type="text" id="q_templateId" name="templateId" class="form-control">
                                  <option value="">选择模板</option>
                                </select>
                              </div>
                              <div class="form-group">
                                <label for="q_region" class="sr-only">地区</label>
                                <input type="hidden" id="q_region" name="region" class="form-control">
                                <input type="text" placeholder="请选择地区" id="q_region_name" name="regionName" onclick="showQueryRegion()"
                                       class="form-control" readonly style="width:150px; ">
                              </div>
                              <div class="form-group">
                                <label for="keywords" class="sr-only">接收次数</label>
                                <input type="text" placeholder="请输入接收次数" id="q_receiveCount" name="receiveCount"
                                       class="form-control" style="width:150px; ">
                              </div>

                              <button type="button" class="btn btn-info table-search-submit" title="查询"><i
                          ...
                          <table id="contact_list" class="table-striped"></table>
                        </div>
                      </div>
                ...
                <div id="tab-2" class="tab-pane">
                  <textarea placeholder="请输入电话号码,多个号码回车分隔" id="phones" name="phones" class="form-control"
...
<div class="modal" id="recordModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" style="width: 80%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <#include "${_ROOT_PATH_}/operation/sms/record/index.ftl">
      </div>
    <#--<div class="modal-footer">
      <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fa fa-close"></i>取消</button>
    </div>-->
