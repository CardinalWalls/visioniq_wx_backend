        ...
        <div class="panel-heading">
          ...
          <form id="record_search_form" name="recordSearchForm">
            <div class="form-inline">
              ...
              <br>
              <div class="form-group">
                <label for="lastLoginStartDate" class="sr-only">最近登录时间始</label>
                <input type="text" placeholder="最近登录时间始" id="lastLoginStartDate" name="lastLoginStartDate" class="form-control layer-date">
              </div>
              <div class="form-group">
                <label for="lastLoginEndDate" class="sr-only">最近登录时间止</label>
                <input type="text" placeholder="最近登录时间止" id="lastLoginEndDate" name="lastLoginEndDate"  class="form-control layer-date">
              </div>
