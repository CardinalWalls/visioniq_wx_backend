        ...
        <div class="modal-body">
          <form class="panel-body form-horizontal" id="template_form" name="templateForm">
            ...
            <div class="form-group">
              ...
              <font>将添加到光标所在位置，并自动$通配处理</font>
                <#list paramMap?keys as key1>
                  <div>
                    <font>${key1}属性常用参数：</font>
                    <#list paramMap[key1] as paramList>
                      <#list paramList?keys as key2>
                      <button style="margin-bottom: 5px;" type="button" class="btn btn-default btn-xs paramClick"
                              data-type="${key1}" data="${key2}">${paramList[key2]}</button>
                      </#list>
                    </#list>
                  </div>
                </#list>
            ...
            <div class="form-group">
              ...
              <button type="button" class="btn btn-xs btn-primary" style="margin-bottom: 5px" onclick="refreshParam()">
                刷新参数
              </button>
              <div>
                <table id="paramTab">
