    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body table-content">
        <div class="table-toolbar">
          ...
          <button onclick="ro.searchAppInfo()" type="button" class="btn btn-success">
            <i class="fa fa-search"></i>
            关联应用菜单
          </button>
          <button onclick="ro.searchMember()" type="button" class="btn btn-info">
            <i class="fa fa-search"></i>
            关联人员
          </button>
      ...
      <div class="modal-body">
        <form class="panel-body form-horizontal" id="role_form" onsubmit="return false">
          ...
          <div class="form-group">
            ...
            <div>
              <select class="form-control input-s-sm inline" id="code" name="code">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="panel-body form-horizontal" id="appInfo_form">
          ...
          <div class="form-group">
            <label for="authUrlPrefix" class="control-label">授权路径：</label>
            <div>
              <textarea type="text" class="form-control" rows="4" name="authUrlPrefix" readonly></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="directory" class="control-label">菜单类别：</label>
            <select class="form-control form-inline" name="type" disabled>
              <option value="0">目录</option>
              <option value="1">菜单页面</option>
              <option value="2">功能资源</option>
            </select>
          </div>
          <div class="form-group">
